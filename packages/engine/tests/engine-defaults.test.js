...
import { DEFAULT_LOCK_TIMEOUT_MS, CLEANUP_INTERVAL_MS, SHUTDOWN_TIMEOUT_MS, SHUTDOWN_FORCE_EXIT_DELAY_MS, SCHEDULER_MAX_ROUNDS, SCHEDULER_ROUND_TIMEOUT_MS, REACT_MAX_LOOPS, EMBEDDING_DIM, EMBEDDING_CACHE_SIZE, CONTENT_HASH_ALGO, VECTOR_DEDUP_THRESHOLD, WEIGHT_AGING_FACTOR, STALE_FREEZE_DAYS, FROZEN_OBLITERATE_DAYS, MAINTENANCE_WEIGHT_THRESHOLD, SCHEMA_VERSION, MONITOR_WINDOW_MS, MONITOR_THRESHOLD, ENGINE_DEFAULTS, loadEngineDefaults, } from "@cortex/engine";
// ── 常量值校验 ──────────────────────────────
...
//# sourceMappingURL=engine-defaults.test.js.map