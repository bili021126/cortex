...
import { bayesianRelevanceScore, fourierTimeDecay, ebbinghausRetention, emotionalBonus, BoundaryRegressor, CognitiveEngine, DEFAULT_COGNITIVE_CONFIG, spreadingActivation, } from "@cortex/memory-store";
...
describe("ebbinghausRetention", () => {
    it("高访问次数记忆衰退更慢", () => {
        ...
        const highAccess = {
            id: "h", source: { agentType: "Code", taskId: "t" },
        ...
        const lowAccess = {
            id: "l", source: { agentType: "Code", taskId: "t" },
            kind: "TaskLog", summary: "a", semantic_gist: "a", content_blob: {},
...
describe("spreadingActivation", () => {
    it("深度衰减正确", () => {
        ...
        const links = {
            "src": [
                { sourceId: "src", targetId: "a" },
                { sourceId: "src", targetId: "b" },
            ],
            "a": [{ sourceId: "a", targetId: "c" }],
        };
        const entries = {
...
describe("CognitiveEngine", () => {
    ...
    it("isForgotten 检测长期未访问记忆", () => {
        ...
        const base = 1717084800000;
        const recent = {
            id: "r", source: { agentType: "Code", taskId: "t" },
        ...
        const veryOld = {
            id: "o", source: { agentType: "Code", taskId: "t" },
...
//# sourceMappingURL=cognitive-engine.test.js.map