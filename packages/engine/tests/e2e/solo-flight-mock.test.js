...
import { Scheduler, createAgent, codeAgentConfig, fixAgentConfig, analysisAgentConfig, opsAgentConfig } from "@cortex/engine";
...
describe("Solo Flight Mock E2E", () => {
    ...
    it("5 节点 × 3 Agent 类型同 scheduler 并发——全部完成", async () => {
        ...
        // 添加 5 个不同类型节点
        const nodes = [
            { id: "impl-a", type: "implementation", tags: ["code"], payload: "Implement module A" },
            { id: "impl-b", type: "implementation", tags: ["code"], payload: "Implement module B" },
            { id: "impl-c", type: "implementation", tags: ["code"], payload: "Implement module C" },
            { id: "arch-review", type: "architecture_analysis", tags: ["analysis"], payload: "Review architecture of A/B/C" },
            { id: "fix-d", type: "bugfix", tags: ["fix"], payload: "Fix defect in module D" },
        ];
...
//# sourceMappingURL=solo-flight-mock.test.js.map