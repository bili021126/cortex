...
for (const [key, info] of Object.entries(agentReportMap)) {
    const candidates = files.filter((f) => f.endsWith(".md") && !f.includes("summary") && !f.includes("roundtable"));
...
//# sourceMappingURL=run-roundtable-standalone.js.map