...
async function main() {
        ...
        for (const [key, info] of Object.entries(agentReportMap)) {
            ...
            try {
                ...
                seedMemories.push({
                    ...
                    source: { agentType: AgentType.Analysis, taskId: `self-exam-report-${key}` },
        ...
        if (rootCauseFile) {
            ...
            try {
                ...
                seedMemories.push({
                    ...
                    source: { agentType: AgentType.Analysis, taskId: "self-exam-root-cause" },
        ...
        if (zhongliFile) {
            ...
            try {
                ...
                seedMemories.push({
                    ...
                    source: { agentType: AgentType.Strategist, taskId: "self-exam-zhongli" },
    ...
    try {
        await runMeeting(SOFT_CONSENSUS_ROUNDTABLE, adapter, CHAT_MODEL, DB_DIR, CONSENSUS_OUTPUT, seedMemories);
...
//# sourceMappingURL=run-soft-consensus-roundtable.js.map