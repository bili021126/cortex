...
import { loadPendingProposals, saveProposal, updateProposalStatus, judgeProposals, applyApproved, summarizeGovernance, findConstitutionPath } from "@cortex/governance";
// ─── 辅助函数 ───────────────────────────────────
function makeTempDir() {
    return fs.mkdtempSync(path.join(os.tmpdir(), "cortex-govloop-test-"));
}
function makeConstitution(dir, version = "v2.5.10") {
...
//# sourceMappingURL=governance-loop.test.js.map