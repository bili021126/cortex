...
export class ConsistencyLayerPlugin {
    name = "consistencyLayer";
    ...
    async init(ctx) {
        ...
        memory.setPreWriteHook((input) => this.instance.preWriteCheck(input));
    }
    async start() {
...
//# sourceMappingURL=consistency-layer.plugin.js.map