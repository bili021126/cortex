 ...
 * 该文件为可选——不存在时返回空默认配置。
 */
export function loadCognitionConfig(_projectRoot, dataDirOverride) {
    const dataDir = dataDirOverride ?? resolveConfigDataDir();
    let config;
    try {
        config = loadConfigDomain("cognition", readFileNode, dataDir);
    }
    catch {
        return {
            activationMatrix: [],
...
//# sourceMappingURL=cognition.loader.js.map