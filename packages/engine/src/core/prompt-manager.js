...
// ============================================================
import { PromptOrchestrator, PromptBlockType, } from "@cortex/prompt-kit";
/**
...
export class PromptManager {
     ...
     */
    async renderAgentPrompt(filePath) {
        try {
     ...
     */
    async assemblePlanningPrompt(blocks) {
        const promptBlocks = [];
        // 按语义优先级排列（低值优先）
     ...
     */
    validateSystemPrompt(agentId, systemPrompt) {
