// ============================================================
// @cortex/engine/core/task-router —— 任务路由器
//
// @layer 规划-执行层
...
// ============================================================
import { loopStrategyRegistry } from "./loop-strategy-registry.js";
/**
 * 任务路由器——统一策略选择和模型选择。
 *
 * 现状问题：
...
export class TaskRouter {
    modelRouter;
    defaultModel;
    constructor(modelRouter, defaultModel) {
     ...
     * 用于拓扑排序后的并行分发场景。
     */
    async routeBatch(nodes, agentType) {
