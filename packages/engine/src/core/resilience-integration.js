...
// ============================================================
import { Registry, ExponentialBackoff, SimpleCircuitBreaker, FixedTimeout, } from "@cortex/resilience";
...
export class ResiliencePolicyFactory {
     ...
     * @param options 韧性配置
     */
    registerPolicies(componentName, options) {
        // 重试策略
     ...
     * @returns 执行结果
     */
    async execute(componentName, fn) {
...
//# sourceMappingURL=resilience-integration.js.map