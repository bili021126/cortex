...
import { AgentPool as AgentPoolClass } from "@cortex/scheduler";
...
export class PoolAwareState {
     ...
     */
    constructor(tagOrProvider = "Agent") {
    ...
    get _tag() {
        try {
            ...
            if (this._safeReporter) {
                ...
                console.warn(`[PoolAwareState._tag] tagProvider 抛异常: ${String(e).slice(0, 200)}`);
            }
            return "Agent";
        }
    }
...
//# sourceMappingURL=pool-aware.js.map