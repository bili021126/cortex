...
export class ButlerAgent {
    observer;
    type = AT.Butler;
    _state = new PoolAwareState(() => this.type);
    _safeReporter = null;
    bridge;
    /** 预先绑定的 handler 引用，供 shutdown() 精确移除 */
    _boundCritical = this._onCritical.bind(this);
    _boundHigh = this._onHigh.bind(this);
    _boundNormal = this._onNormal.bind(this);
    get status() {
...
//# sourceMappingURL=butler-agent.js.map