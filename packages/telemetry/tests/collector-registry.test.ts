...
import type { ITelemetryCollector, TelemetryData, CollectResult } from "../src/index.js";

// ─── Mock Collector ───────────────────────────────

class MockCollector implements ITelemetryCollector {
  ...
  async collect(_data: TelemetryData): Promise<CollectResult> {
    if (this._shutdown) {
