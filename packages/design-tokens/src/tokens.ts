...
// ─── ChatView 界面令牌（F7 单源化——desktop ChatView 的粉白深色界面） ──
// 镜像自 desktop/src/renderer/ui/tokens.css（62 项）——CSS 变量形态由守护测试保证一致
/** ChatView 界面令牌（--rb-* 的权威值） */
export const CHAT_PALETTE: Record<string, string> = {
  "bg-0": "#08070f",
  "bg-1": "#0f0d1f",
  "bg-2": "#181432",
  "bg-3": "#221c46",
  ...
  "border-strong": "rgba(236, 72, 153, 0.40)",
  "grad-pink": "linear-gradient(135deg, #ec4899 0%, #9f7aea 100%)",
  "grad-pink-hot": "linear-gradient(135deg, #ff6ec7 0%, #ec4899 50%, #9f7aea 100%)",
  "glow-pink": "0 0 20px rgba(236, 72, 153, 0.35)",
  "glow-soft": "0 0 12px rgba(236, 72, 153, 0.18)",
  "glow-violet": "0 0 24px rgba(157, 127, 234, 0.28)",
  "radius-xs": "4px",
  "radius-sm": "6px",
  "radius-md": "8px",
  "radius-lg": "12px",
  ...
  "text-body": "400 16px/1.50 var(--rb-font-sans)",
  "text-small": "400 14px/1.50 var(--rb-font-sans)",
  "text-caption": "400 13px/1.70 var(--rb-font-sans)",
  "text-micro": "400 12px/1.50 var(--rb-font-sans)",
  "text-btn": "600 14px/1.40 var(--rb-font-sans)",
  "text-title": "600 20px/1.40 var(--rb-font-sans)",
  "shadow-card": "0 4px 16px rgba(0, 0, 0, 0.35)",
  "input-bg": "rgba(255, 255, 255, 0.06)",
  "input-border": "rgba(236, 72, 153, 0.18)",
  "input-text": "#ebe5f5",
  "input-placeholder": "rgba(235, 229, 245, 0.48)",
