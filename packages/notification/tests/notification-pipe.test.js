...
import { NotificationChannel, DEFAULT_CHANNEL_CONFIGS, RouteTable, UrgentChannel, ImportantChannel, RoutineChannel, InfoChannel, NotificationPipe, } from "../src/index.js";
// ════════════════════════════════════════════════════════
// RouteTable 测试
// ════════════════════════════════════════════════════════
describe("RouteTable", () => {
...
describe("NotificationPipe", () => {
    ...
    describe("归并缓冲", () => {
        it("setMergeRules → 事件同 mergeKey 进入缓冲区", () => {
            ...
            const mergedEvent = handler.mock.calls[0][0];
...
//# sourceMappingURL=notification-pipe.test.js.map