...
import { PipelineEventType } from "../src/index.js";
describe("EventPayloadMap 一致性", () => {
    ...
    it("每个 PipelineEventType 都在 EventPayloadMap 中有对应条目", () => {
        const evtValues = Object.values(PipelineEventType).filter((v) => typeof v === "string");
...
//# sourceMappingURL=event-payload-map.test.js.map