...
import { getEmbeddingProvider, EmbeddingProvider } from "./embedding.js";
...
export class JsonVectorStore {
  ...
  /** 内部访问器，供 retriever 等模块使用 */
  get entriesList(): readonly RagMemoryEntry[] {
    return this.entries;
  }
}