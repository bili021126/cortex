 ...
 */
export enum MemoryStoreErrorCode {
  /** 存储实例未注册 */
...
export class MemoryNotFoundError extends MemoryStoreError {
  constructor(memoryId: string, context?: Record<string, unknown>) {
    super(
      MemoryStoreErrorCode.MemoryNotFound,
      `Memory entry not found: ${memoryId}`,
      { ...context, memoryId },
    );
...
export class StoreNotFoundError extends MemoryStoreError {
  constructor(storeName: string) {
    super(
      MemoryStoreErrorCode.StoreNotFound,
      `Memory store not registered: ${storeName}`,
      { storeName },
    );
...
export class StoreAlreadyExistsError extends MemoryStoreError {
  constructor(storeName: string) {
    super(
      MemoryStoreErrorCode.StoreAlreadyExists,
      `Memory store already registered: ${storeName}`,
      { storeName },
    );
...
export class MemoryValidationError extends MemoryStoreError {
  ...
  constructor(fields: string[], message?: string, context?: Record<string, unknown>) {
    super(
      MemoryStoreErrorCode.MemoryValidation,
...
export class TransactionError extends MemoryStoreError {
  ...
  constructor(message: string, transactionId?: string, context?: Record<string, unknown>) {
    super(
      MemoryStoreErrorCode.TransactionFailed,
      message,
...
export class PersistenceError extends MemoryStoreError {
  ...
  constructor(message: string, cause?: Error, context?: Record<string, unknown>) {
    super(
      MemoryStoreErrorCode.PersistenceFailed,
      message,
