...
export function createTool(ctx) {
    return new LocalTool("run_test", ToolCategory.Shell, "Run tests with automatic test framework detection (vitest, jest, playwright, mocha). Detects the framework from config files, or use the 'framework' parameter to specify manually.", {
        type: "object",
        properties: {
            test_path: {
                type: "string",
