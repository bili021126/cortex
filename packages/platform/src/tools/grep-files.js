...
export function createTool(ctx) {
    return new LocalTool("grep_files", ToolCategory.Search, "Search for a pattern within a specific list of files. Unlike search_code (project-wide ripgrep), this searches only the exact files you specify. Returns file:line:content matches.", {
        type: "object",
        properties: {
