...
function makeTemplate(id, version, blocks) {
    return {
        id,
        name: id,
        version,
...
describe("PromptVersion", () => {
    ...
    describe("diff", () => {
        it("应正确计算版本差异", () => {
            ...
            versionManager.recordChange({ templateId: "t", version: "1.0.0", changeDescription: "v1", changedBy: "test", timestamp: 1, blocksChanged: [] }, v1);
            versionManager.recordChange({ templateId: "t", version: "2.0.0", changeDescription: "v2", changedBy: "test", timestamp: 2, blocksChanged: [] }, v2);
