...
import { PromptBlockType, PromptErrorCode } from "../types.js";
...
export class FilePromptSource {
     ...
     * 递归扫描目录。
     */
    scanRecursive(currentPath, basePath) {
     ...
     */
    parseFile(filePath, templateId) {
        if (!existsSync(filePath)) {
            throw new PromptError(`文件不存在: ${filePath}`, PromptErrorCode.LOAD_FAILED, { filePath, templateId });
        }
