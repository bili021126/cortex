...
/** 光标移动到指定列 */
export function cursorToColumn(col) {
    return `${CSI}${col}G`;
}
/** 隐藏光标 */
...
/** ANSI 256 色 */
export function color256(text, code) {
...
export class Box {
    ...
    buffer;
    prev;
    topRow; // 此 Box 在屏幕上的起始行（0-based）
    constructor(width, height, topRow = 0) {
        this.width = width;
        this.height = height;
        this.topRow = topRow;
