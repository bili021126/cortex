 ...
 */
export function reversibilityLevel(tool) {
    if (L1_TOOLS.has(tool))
        return 1;
    if (L3_TOOLS.has(tool))
        return 3;
    return 2;
}
// ═══════════════════════════════════════════════════════════
 ...
 */
export function renderInlinePermission(tool, input, level) {
 ...
 * 清除 inline 权限提示。
 */
export function clearInlinePermission() {
    // 上移一行并清除
 ...
 */
export async function waitForSingleKey(timeoutMs = 30000) {
