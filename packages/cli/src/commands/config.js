...
export function createConfigHandler(configManager) {
...
function handleConfigList(config, options, _context) {
...
function handleConfigGet(config, key, _context) {
    if (!key) {
...
function handleConfigSet(config, key, value) {
...
function handleConfigInit(options, _context) {
    const global_ = options["global"];
...
function handleConfigValidate(config, options, _context) {
