...
export function createConfirmHandler(bridge) {
...
function handleConfirmPending(gate) {
...
function handleConfirmApprove(gate, requestId) {
    if (!requestId) {
...
function handleConfirmReject(gate, requestId) {
    if (!requestId) {
