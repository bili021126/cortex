...
describe("extractWorkspacePath — 从意图中提取工作区路径", () => {
    ...
    it('匹配带逗号分隔', () => {
        const result = extractWorkspacePath("将这个路径作为工作区, D:\\Projects\\study\\my-test");
        expect(result).toBe("D:\\Projects\\study\\my-test");
    });
    it('匹配无后续文本', () => {
    ...
    it('匹配 "将这个路径作为工作区，对 D:\\path 做..."', () => {
        const result = extractWorkspacePath("将这个路径作为工作区，对 D:\\Projects\\study\\my-test 做全栈数据层分析");
        expect(result).toBe("D:\\Projects\\study\\my-test");
    });
    // ── 模式2：以...为工作区 ──
    it('匹配 "以 D:\\foo 为工作区"', () => {
    ...
    it("只取第一个匹配的工作区声明", () => {
        const result = extractWorkspacePath("将这个路径作为工作区，D:\\first，再以 D:\\second 为工作区对比");
...
//# sourceMappingURL=plan-executor.test.js.map