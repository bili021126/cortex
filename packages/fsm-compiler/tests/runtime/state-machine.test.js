...
describe("StateMachine", () => {
    it("should start in the initial state", () => {
        const machine = new StateMachine(agentPoolDef, "created");
    ...
    it("should throw on invalid transition", () => {
        const machine = new StateMachine(agentPoolDef, "created");
        expect(() => machine.dispatch("complete")).toThrow(TransitionError);
    });
    ...
    it("should check guard before transition", () => {
        ...
        const machine = new StateMachine(agentPoolDef, "created", { guards });
        machine.dispatch("wakeup");
    ...
    it("should execute action on transition", () => {
        ...
        const machine = new StateMachine(agentPoolDef, "created", { actions });
        machine.dispatch("wakeup");
    ...
    it("should serialize and deserialize snapshots", () => {
        ...
        const restored = StateMachine.deserialize(snapshot, agentPoolDef);
