...
import { FsmParseError, TransitionError, GuardError, } from "../src/types.js";
// ════════════════════════════════════════════════════════════════
// FsmParseError
// ════════════════════════════════════════════════════════════════
...
describe("FsmStateDefinition (structural)", () => {
    ...
    it("should accept all style variants", () => {
        const initial = { id: "a", style: "initial" };
        const normal = { id: "b", style: "normal" };
        const final = { id: "c", style: "final" };
        const error = { id: "d", style: "error" };
...
describe("FsmTransitionDefinition (structural)", () => {
    ...
    it("should accept all transition types", () => {
        const external = { id: "t1", from: "a", to: "b", event: "e", type: "external" };
        const internal = { id: "t2", from: "a", to: "a", event: "e", type: "internal" };
        const self = { id: "t3", from: "a", to: "a", event: "e", type: "self" };
    ...
    it("should default type to undefined (external)", () => {
        const t = { id: "t1", from: "a", to: "b", event: "e" };
...
describe("Validation types (structural)", () => {
    ...
    it("should accept all ValidationErrorCode variants", () => {
        ...
        codes.forEach((code) => {
            const err = { code: code, nodeId: "x", message: code };
