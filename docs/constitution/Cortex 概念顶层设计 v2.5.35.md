...
**版本**：v2.5.36（修宪——Agent 声明式注册表 v3.0.0 入宪：FixAgent 等 9 个 Agent 已从独立文件重构为 AGENT_REGISTRY 数组 + namedExports() 工厂生成。AM-2026-0531-008；2026-05-31；来源：昔涟（提案+评判）+ 开拓者（裁决））
> 
...
| **ButlerAgent** | web_search（管家信息检索） | 不认领节点 | IDE 内部管线路由，常驻 | Core-1（昔涟的管线侧代码承载体） |
