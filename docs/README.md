...
| # | 文档 | 定位 | 什么时候读 |
|---|------|------|-----------|
| 1 | [constitution/Cortex 概念顶层设计 v3.0.md](constitution/Cortex%20概念顶层设计%20v3.0.md) | **现行宪法 v3.0**——代码即真相。Core-1 终局归档 + Core-2 过渡期收束。 | 任何时候。这是唯一权威。 |
| — | [constitution/Cortex 概念顶层设计 v2.5.35.md](constitution/Cortex%20概念顶层设计%20v2.5.35.md) | 前代宪法 v2.7.1。已被 v3.0 替代，保留为历史参考。 | 追溯历史修宪记录时 |
...
| 文档 | 定位 |
|------|------|
| **Cortex 概念顶层设计 v2.5.35.md** | **现行宪法**（1606行） |
| archive/ | 宪法版本备份（10+份自动备份，不需要手动阅读） |
| backup/ | 修宪前备份（2份） |
