...
async function main() {
    ...
    for (const entry of results) {
        const cat = entry.content_blob?.category ?? "未分类";
    ...
    lines.push("", "> *「人们会踩起岁月的涟漪，循依昨日，走向明天」——如我所书*", "");
...
//# sourceMappingURL=export-cyrene-memories.js.map